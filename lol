...
Intended experiments: we can use train test split, bootstrap, k-fold cross-validation, 
confusion matrix to evaluating the performance of the models.
...
also we can split data into 20 cloumns, to use regression see probability or outcome that team win game or not.
